...
<!-- Modal -->
<div class="modal fade bg-light" id="add_admin"  tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered modal-sm">
    <div class="modal-content">
      <div class="modal-body">
        <center>
          <h5 class="text-primary mb-2">Register</h5>
        </center>
          <form action="inc/process_registration.php" method="post" enctype="multipart/form-data">
        <div class="row">
          <div class="col-md-12">

            <p class="mb-0 mt-3"> <small>Full Name</small></p>
            <input type="text" name="name" class="form-control" placeholder="title" aria-label="title" aria-describedby="basic-addon1" required>

            <p class="mb-0 mt-3"> <small>Phone #</small></p>
            ...
            <p class="mb-0 mt-3"> <small>Email</small></p>
            ...
            <div>
              <button class="btn btn-primary rounded-0 btn-sm mt-4 shadow-lg m-2" name="add_user" style="width: 100%">Register</button>
            </div>
          </div>
        </form>
        </div>
